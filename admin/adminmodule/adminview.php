            ...
            <div class="col-lg-12">
              ...
              <br>         
                ...
                echo " <tr>
                      <td>".$c++."</td>
                      <td>".$rows['ADM_NAME']."</td>
                      <td>".$rows['ADM_EMAIL']."</td>
                      <td>".$rows['ADM_MOBILENO']."</td>
                      <td>".$rows['ADM_USERNAME']."</td>
                      <td>".$rows['ADM_PASSWORD']."</td>
                      <td>".$rows['ADM_DOBE']."</td>
                      
                      <td><a href='deleteadmin.php?id=".$rows['ADM_ID']."' class='btn btn-danger btn-icon-split'>
