      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
         <div class=" align-items-center justify-content-between mb-4">
            <h5 class=" text-gray-800" style="text-align: center;">Welcome to Add Stundent Module.</h5>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-8">
              ...
              <div class="card mb-4">
                <div class="flex-row">
                  <h6 class=" font-weight-bold text-primary" style="text-align: center;margin-top: 20px;">Student Add</h6>
                </div>
                <div class="card-body">
                  <form action="addstudent.php" method="POST">
                    ...
                    <button class="btn btn-primary" value="Register" name="submit" >Add</button>
                  </form>
                </div>
              </div>
            </div>
