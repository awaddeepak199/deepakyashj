      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
         <div class=" align-items-center justify-content-between mb-4">
            <h5 class=" text-gray-800" style="text-align: center;">Welcome to Admin Test Module.</h5>
          </div>
              ...
              <div class="card h-100">
                <div class="card-body" >
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold  mb-1" style="text-align: center;font-size: 20px">Added new Test</div>
                      <br>
                      <a href="addtest.php"><div class="text-xs font-weight-bold  mb-1" style="text-align: center;font-size: 15px"><button class="btn-success">Proceed</button></div></a>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body" >
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold  mb-1" style="text-align: center;font-size: 20px">View Test</div>
                      <br>
                      <a href="viewtest.php"><div class="text-xs font-weight-bold  mb-1" style="text-align: center;font-size: 15px"><button class="btn-danger">Proceed</button></div></a>
                      <div class="mt-2 mb-0 text-muted text-xs">
                      </div>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body" >
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold  mb-1" style="text-align: center;font-size: 20px">History</div>
                      <br>
                       <a href="history.php"><div class="text-xs font-weight-bold  mb-1" style="text-align: center;font-size: 15px"><button class="btn-warning">Proceed</button></div></a>
                      <div class="mt-2 mb-0 text-muted text-xs">
                      </div>
                    </div>
