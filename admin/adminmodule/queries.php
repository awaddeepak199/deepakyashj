      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
         <div class=" align-items-center justify-content-between mb-4">
            <h5 class=" text-gray-800" style="text-align: center;">Welcome to Student Queries Solution.</h5>
          </div>
              ...
              <br>         
                <table class="table">
                  ...
                  $pass='';
                   ...
                   $db = new mysqli('localhost',$user,$pass,$db) or die("die");
                   $query="SELECT web_problem.WEB_ID,studentreg.STD1_NAME,web_problem.WEB_SELECT,web_problem.WEB_TITLE,web_problem.WEB_DESCRIPTION FROM web_problem INNER JOIN studentreg on studentreg.STD1_ID = web_problem.WEB_STUDENT";
                   $result=mysqli_query($db,$query);
                while($rows=mysqli_fetch_assoc($result))
                echo " <tr>
                      <td>".$c++."</td>
                      <td>".$rows['STD1_NAME']."</td>
                      <td>".$rows['WEB_SELECT']."</td>
                      <td>".$rows['WEB_TITLE']."</td>
                      <td>".$rows['WEB_DESCRIPTION']."</td>
                      <td><a href='deletequery.php?id=".$rows['WEB_ID']."' class='btn btn-danger btn-icon-split'>
