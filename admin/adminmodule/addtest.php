         ...
         <div class=" align-items-center justify-content-between mb-4">
          ...
          <div class="row mb-3">
            ...
            <div class="col-lg-10">
              ...
              <div class="card mb-4">
                <div class="flex-row">
                  <h6 class=" font-weight-bold text-primary" style="text-align: center;margin-top: 20px;">Add Test Details</h6>
                </div>
                <hr>
                <div class="card-body">
                  <form action="addtest.php" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="questions" >
                    </div>
                  </div>
                    <div class="col-lg-6">
                    <div class="form-group">
                      <label>Enter Right Marks for Each Question</label>
                      <input type="number" class="form-control" name="correct"  >
                    </div>
                    </div>
                    <div class="col-lg-6">
                    <div class="form-group">
                      <label>Enter wrong Marks for Each Question </label>
                      <input type="numebr" class="form-control" name="wrong" >
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-lg-6">
                    <button class="btn btn-danger" value="Register" name="submit" >Add</button>
                    </div>
                  </div>
                  </form>
                </div>
                ...
                echo '<script>alert("Name is required !");
                      ...
                      {
                       echo '<script> 
                       alert("Number of questions are required !");
                       </script>';
                     }
                     elseif (empty($_POST['correct'])) 
                     {
                   echo '<script>alert("correct mark field is required !");
                   </script>';
                  
                     }elseif (empty($_POST['wrong'])) 
                     {
                       echo '<script>alert("wrong mark field is required !");
                       </script>';
                     }elseif (mysqli_query($db,"INSERT INTO quiz VALUES('$eid','$name','$questions','$correct','$wrong',now())")) 
                   {
                     echo '<script>
                    ...
                    echo '<script>alert("Something Wrong !")
                     document.location.href="addtest.php";
                   </script>';
