      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class=" align-items-center justify-content-between mb-4">
           <p class="p-2 bg-dark text-white text-center " style="font-size: 18px">History</p>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <br>         
                ...
                echo " <tr>
                      ...
                      <td>".$rows['score']."</td>
                      <td>".$rows['date']."</td>
                      <td><a href='deletehistory.php?id=".$rows['historyid']."' class='btn btn-danger btn-icon-split'>
