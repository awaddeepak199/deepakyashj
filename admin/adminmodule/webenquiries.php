      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
         <div class=" align-items-center justify-content-between mb-4">
            <h5 class=" text-gray-800" style="text-align: center;">Welcome to Web Queries.</h5>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <br>         
                ...
                echo " <tr>
                      <td>".$c++."</td>
                      <td>".$rows['ENQ_NAME']."</td>
                      <td>".$rows['ENQ_EMAIL']."</td>
                      <td>".$rows['ENQ_NUMBER']."</td>
                      <td>".$rows['ENQ_MESAGE']."</td>
                      <td><a href='deleteenquiry.php?id=".$rows['ENQ_ID']."' class='btn btn-danger btn-icon-split'>
