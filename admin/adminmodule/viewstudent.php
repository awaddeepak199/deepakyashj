            ...
            <div class="col-lg-12">
              ...
              <br>         
                ...
                echo " <tr>
                      ...
                      <td>".$rows['STD1_EMAIL']."</td>
                      <td>".$rows['STD1_MOBILENO']."</td>
                      <td>".$rows['STD1_USERNAME']."</td>
                      <td>".$rows['STD1_PASSWORD']."</td>
                      <td><a href='deletestudent.php?id=".$rows['STD1_ID']."' class='btn btn-danger btn-icon-split'>
