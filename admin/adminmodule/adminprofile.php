                ...
                <div class="card-body">
                  <form action="addstudent.php" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="'.$rows['ADM_NAME'].'" name="name" disabled >
                    </div>
                    </div>
                    <div class="col-lg-6">
                    <div class="form-group">
                      <label>Email Address</label>
                      <input type="text" class="form-control" value="'.$rows['ADM_EMAIL'].'" name="email" disabled>
                    </div>
                  </div>
                    <div class="col-lg-6">
                    <div class="form-group">
                      <label>Mobile No</label>
                      <input type="number" class="form-control" value="'.$rows['ADM_MOBILENO'].'" name="number" disabled >
                    </div>
                    </div>
                    <div class="col-lg-6">
                    <div class="form-group">
                      <label>Username</label>
                      <input type="text" class="form-control" value="'.$rows['ADM_USERNAME'].'" name="username" disabled>
                    </div>
                  </div>
                    <div class="col-lg-12">
                    <div class="form-group">
                      <label>Password</label>
                      <input type="text" class="form-control" value="'.$rows['ADM_PASSWORD'].'" name="password" disabled>
                    </div>
                  </div>
                  </div>
