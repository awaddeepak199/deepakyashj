      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class=" align-items-center justify-content-between mb-4">
           <p class="p-2 bg-dark text-white text-center " style="font-size: 18px">List of quiz</p>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <br>         
                ...
                echo " <tr>
                      ...
                      <td>".$rows['QU_TITLE']."</td>
                      <td>".$rows['QU_TOTAL']."</td>
                      <td>".$rows['QU_CORRECT']."</td>
                      <td>".$rows['QU_WRONG']."</td>
                      <td><a href='quizquestion.php?q=quizquestion.php&eid=".$rows['eid']."&total=".$rows['QU_TOTAL']."' class='btn btn-primary btn-icon-split'>
                    <span class='icon text-white-50'>
                      <i class='fas fa-edit'></i>Start
                    </span>
                  </a></td>
                      <td><a href='deletequiz.php?q=deleteqns&eid=".$rows['eid']."' class='btn btn-danger btn-icon-split'>
                    <span class='icon text-white-50'> 
