...
<body id="page-top">
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class=" align-items-center justify-content-between mb-4">
            ...
            <h4 class=" text-gray-800" style="text-align: center;"><b> Credit Card as an Identity Threat</b></h4>
            <hr>
        ...
        <div class="row">
          <div class="col-md-12" style="padding-top: 20px">
            ...
            <p style="padding-left: 50px">
              * Any credit card fraud detection system is to identify suspicious events and report them to an analyst while letting normal transactions be automatically processed. <br>
        ...
        <hr>
          ...
          <div class="col-md-12" style="padding-top: 20px">
            ...
            <p style="padding-left: 50px">
              * Interpret IoT concepts.<br>
              * Detect Network, Operating System and applications vulnerabilities.<br>
      ...
      <div class="row">
          <div class="col-md-12">
            <p style="padding-left:30px;color: red;"><b> You can download Project abstract from here. Click Download Button:</b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="ede.docx" download><button  type="button" class="btn btn-primary mb-1">Download</button></a></p>
        </div>
      </div>
