    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <h4 style="text-align: center;"><b>Welcome To Project. Learn and download projects free.</b></h4>
              ...
              <div class="card h-150">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-10" style="text-align:center;font-size: 20px;">
                        ATM Machine System in<br> Python
                      <br>    
                      </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;">
                       <a href="pro/atmpython.php">
                      <button  type="button" class="btn btn-danger mb-1">View Details</button>
                     </a>
                   </div>
                    </div>
                  </div>
              ...
              <div class="card h-150">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-10" style="text-align:center;font-size: 20px;">
                        Credit Card Fraud in Emerging Trends
                      <br>
                      </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;">
                       <a href="pro/creditcard.php">
                      <button  type="button" class="btn btn-danger mb-1">View Details</button>
                     </a>
                   </div>
                    </div>
              ...
              <div class="card h-150">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-10" style="text-align:center;font-size: 20px;">
                        DeadLock <br>in Operating System
                      <br>    
                      </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;">
                       <a href="pro/os.php">
              ...
              <div class="card h-150">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-10" style="text-align:center;font-size: 20px;">
                        Resturant System in Enterpreneurship Developement
                      <br>    
                      </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;">
                       <a href="pro/resturant.php">
                      <button  type="button" class="btn btn-danger mb-1">View Details</button>
                     </a>
                   </div>
                    </div>
              ...
              <div class="card h-150">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold mb-10" style="text-align:center;font-size: 20px;">
                        Mobile Technology Is Hazordous Impact On Environment
                      <br>    
                      </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;">
                       <a href="pro/environemnt.php">
                      <button  type="button" class="btn btn-danger mb-1">View Details</button>
                     </a>
                   </div>
                    </div>
