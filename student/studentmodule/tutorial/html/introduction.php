      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class=" align-items-center justify-content-between mb-4">
            ...
            <h4 class=" text-gray-800" style="text-align: center;"><b> Html Introduction</b></h4>
            <div class="row">
            <div class="col-md-10">
                <a href="htmlmain.php">
        ...
        <div class="row">
          <div class="col-md-12" style="padding-top: 20px">
            <h4><b>What is HTML ?</b></h4><br>
            <p style="padding-left: 50px">
              * HTML is stands for HyperText Markup Language.
              <br>* HTML is the standard markup language for creating Web pages.
              <br>* HTML describes the structure of a Web page.
              <br>* HTML consists of a series of elements.
              <br>* HTML elements tell the browser how to display the content.
              <br>* HTML elements label pieces of content such as "this is a heading", "this is a paragraph", "this is a link", etc.
            </p>
          </div>
        </div>
        <hr>
        ...
        <div class="row">
          <div class="col-md-12">
            <h2><b>A simple HTML document.</b></h2>
        ...
        <div class="row">
          <div class="col-md-12">
            <h4><b>Example Explained</b></h4><br>
            <p style="padding-left: 50px">* The <b>!DOCTYPE html</b> declaration defines that this document is an HTML5 document
              <br>* The <b>html</b> element is the root element of an HTML page.
              <br>* The <b>head</b> element contains meta information about the HTML page
              <br>* The <b>title</b> element specifies a title for the HTML page (which is shown in the browser's title bar or in the page's tab)
              <br>* The <b>body</b> element defines the document's body, and is a container for all the visible contents, such as headings, paragraphs, images, hyperlinks, tables, lists, etc.
              <br>* The <b>h1</b> element defines a large heading.
              <br>* The <b>p</b> element defines a paragraph.
            </p>
          </div>
        </div>
        <hr>
        ...
        <div class="row">
          <div class="col-md-12" style="padding-left: 30px">
            <h3><b>What is an HTML Element?</b></h3>
            <p>An HTML element is defined by a start tag, some content, and an end tag:</p>
            <h6>Start with tagname and end with /tagname.<h6><br>
              <p>Tags are:</p>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p style="padding-left:30px"> The purpose of a web browser (Chrome, Edge, Firefox, Safari) is to read HTML documents and display them correctly.<br>A browser does not display the HTML tags, but uses them to determine how to display the document:</p>
            <img src="../../../../files/img/img_chrome.png" class="img-responsive">
        </div>
      </div>
