      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class=" align-items-center justify-content-between mb-4">
            ...
            <h4 class=" text-gray-800" style="text-align: center;"><b> Html File Path</b></h4>
            <div class="row">
            <div class="col-md-10">
                <a href="forms.php">
        ...
        <div class="row">
          <div class="col-md-12">
            <h5>A file path describes the location of a file in a web site's folder structure.</h5>
          </div>
        </div>
        <hr>
        ...
        <div class="row">
          <div class="col-md-12">
            <h4><b>HTML File Paths</b>
              <br><h6> file path describes the location of a file in a web site's folder structure.
File paths are used when linking to external files, like:</h6><br>
        ...
        <div class="row">
          <div class="col-md-12">
            <h3><b>Absolute File Paths</b></h3>
            <p style="padding-left: 50px;">An absolute file path is the full URL to a file:</p>
        ...
        <div class="row">
          <div class="col-md-12">
           <h3><b>Relative File Paths</b></h3>
            <p style="padding-left: 50px;">A relative file path points to a file relative to the current page.</p>
             <div class="row justify-content-center">
               <div class="col-xl-9 col-lg-10 col-md-9" >
                 <div class="card shadow-sm my-5">
                   <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-md-12">
            <p style="padding-left: 50px;">In the following example, the file path points to a file in the images folder located in the current folder:</p>
             <div class="row justify-content-center">
               <div class="col-xl-9 col-lg-10 col-md-9" >
                 <div class="card shadow-sm my-5">
                   <div class="card-body p-0">
                ...
                <div class="row">
          <div class="col-md-12">
            <p style="padding-left: 50px;">In the following example, the file path points to a file in the images folder located in the folder one level up from the current folder:</p>
             <div class="row justify-content-center">
               <div class="col-xl-9 col-lg-10 col-md-9" >
                 <div class="card shadow-sm my-5">
                   <div class="card-body p-0">
