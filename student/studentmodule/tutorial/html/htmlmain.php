      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class=" align-items-center justify-content-between mb-4">
            ...
            <h4 class=" text-gray-800" style="text-align: center;"><b>Welcome To Html Tutorial</b></h4>
            <div class="row">
            <div class="col-md-11">
                <a href="htmlmain.php">
            <button  type="button" class="btn btn-primary mb-1">Home</button>
          </a>
          </div>
            <div class="col-md-1">
        ...
        <div class="row">
          <div class="col-md-12">
            <h2>Easy Learning With HTML "Try it Yourself!".</h2><br>
            <h4>With our "Try it Yourself" editor, you can edit the HTML code and view the result:</h4><br>
          ...
          <h4><b>Click on Try it to editor.. and see how it is work.</b></h4>
        </div>
        <hr>
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <h2><b>Html Projects</b></h2>
            <h5>Works with HTML Projects.</h5><br>
              <a href="../../project/project.php">
            <button  type="button" class="btn btn-primary mb-1">Videos</button>
          </a>
          </div>
        </div>
        <hr>
        ...
        <div class="row">
          <div class="col-md-12">
            <h2><b>Html Videos</b></h2>
            <h5>Views with the HTML vidoes for better understanding..</h5><br>
              <a href="../../video/studentvideo.php">
            <button  type="button" class="btn btn-primary mb-1">Videos</button>
          </a>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <h2><b>Html Test</b></h2>
            <h5>Test your HTML skills with our HTML Quiz!</h5><br>
              <a href="../../test/testmain.php">
            <button  type="button" class="btn btn-primary mb-1">Start your Test</button>
          </a>
          </div>
        </div>        
        <div>
        ...
        <p>ELearning is optimized for learning platform. Examples might be simplified to improve reading and learning. Tutorials, references, and examples are constantly reviewed to avoid errors, but we cannot warrant full correctness of all content. While using ELearning, you agree to have read and accepted our terms of use, cookie and privacy policy.</p><br>
        <p>Copyright 2021 by ELearning Data.<br> All Rights Reserved.
             ELearning is Powered by Deepak.</p>
            </div>
            <div class="col-md-1">
            </div>
          </div>
